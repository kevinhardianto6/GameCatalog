...
final class GameProvider: NSObject {
  ...
  lazy var persistentContainer: NSPersistentContainer = {
    if let bundle = Bundle(identifier: GameBundle.getIdentifier()), let managedObjectModel = NSManagedObjectModel(contentsOf: bundle.url(forResource: "FavouriteGames", withExtension: "momd")!) {
